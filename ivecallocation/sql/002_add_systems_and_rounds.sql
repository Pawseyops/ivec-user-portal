...
INSERT INTO allocation_allocationround (system_id, start_date, end_date) VALUES
    ((SELECT id from allocation_system where name='Epic'), '1970-01-01', '2011-10-01');
...
UPDATE allocation_application SET allocation_round_id=(SELECT id from allocation_allocationround WHERE
    system_id=(SELECT id from allocation_system where name='Epic')) ;
