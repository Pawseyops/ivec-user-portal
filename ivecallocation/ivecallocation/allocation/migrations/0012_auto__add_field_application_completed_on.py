...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.completed_on'
        db.add_column('allocation_application', 'completed_on', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Application.completed_on'
        db.delete_column('allocation_application', 'completed_on')
    ...
    models = {
        ...
        'allocation.emailtemplate': {
            'Meta': {'object_name': 'EmailTemplate'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'template': ('django.db.models.fields.CharField', [], {'max_length': '8192', 'blank': 'True'})
        },
        ...
        'allocation.participant': {
            ...
            'participantaccount': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participant'", 'null': 'True', 'to': "orm['allocation.ParticipantAccount']"}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['allocation.ParticipantStatus']"}),
        ...
        'allocation.reviewercomment': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['allocation.Application']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reviewercomment_reviewers'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'allocation.reviewerscore': {
            ...
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reviewerscore_reviewers'", 'null': 'True', 'to': "orm['auth.User']"}),
