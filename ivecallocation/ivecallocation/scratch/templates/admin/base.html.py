...
_magic_number = 8
_modified_time = 1349852755.04125
_enable_loop = True
_template_filename = u'/usr/local/webapps/ivecallocation/virtualenv/lib/python2.6/site-packages/Mango_py-1.3.1_ccg1_3-py2.6.egg/django/contrib/admin/templates/mako/admin/base.html'
...
def render_block_userlinks(context):
    ...
    try:
        ...
        if docsroot:
            # SOURCE LINE 59
            __M_writer(u'<a href="')
            __M_writer(unicode(docsroot))
            __M_writer(u'">')
            __M_writer(unicode(trans('Documentation')))
            __M_writer(u'</a> / \n')
        # SOURCE LINE 61
        __M_writer(u'<a href="')
        __M_writer(unicode( (root_path+'password_change/') if not resolvers.reverse('admin:password_change') else resolvers.reverse('admin:password_change') ))
        __M_writer(u'">')
        __M_writer(unicode(trans('Change password')))
