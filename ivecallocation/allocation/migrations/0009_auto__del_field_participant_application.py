...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Participant.application'
        db.delete_column('allocation_participant', 'application_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Participant.application'
        raise RuntimeError("Cannot reverse this migration. 'Participant.application' and its values cannot be restored.")
    ...
    models = {
        ...
        'allocation.application': {
            ...
            'participant': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['allocation.Participant']", 'symmetrical': 'False'}),
