...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('allocation_priorityarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('allocation', ['PriorityArea'])

        # Adding model 'AllocationRound'
        db.create_table('allocation_allocationround', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allocation.System'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal('allocation', ['AllocationRound'])

        # Adding M2M table for field priority_area on 'AllocationRound'
        db.create_table('allocation_allocationround_priority_area', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('allocationround', models.ForeignKey(orm['allocation.allocationround'], null=False)),
            ('priorityarea', models.ForeignKey(orm['allocation.priorityarea'], null=False))
        ))
        db.create_unique('allocation_allocationround_priority_area', ['allocationround_id', 'priorityarea_id'])

        # Adding model 'System'
        db.create_table('allocation_system', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('allocation', ['System'])

        # Adding field 'Application.allocation_round'
        db.add_column('allocation_application', 'allocation_round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allocation.AllocationRound'], null=True), keep_default=False)

        # Adding field 'Application.priority_area'
        db.add_column('allocation_application', 'priority_area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allocation.PriorityArea'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PriorityArea'
        db.delete_table('allocation_priorityarea')

        # Deleting model 'AllocationRound'
        db.delete_table('allocation_allocationround')

        # Removing M2M table for field priority_area on 'AllocationRound'
        db.delete_table('allocation_allocationround_priority_area')

        # Deleting model 'System'
        db.delete_table('allocation_system')

        # Deleting field 'Application.allocation_round'
        db.delete_column('allocation_application', 'allocation_round_id')

        # Deleting field 'Application.priority_area'
        db.delete_column('allocation_application', 'priority_area_id')
    ...
    models = {
        'allocation.allocationround': {
            ...
            'priority_area': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['allocation.PriorityArea']", 'null': 'True', 'symmetrical': 'False'}),
            'start_date': ('django.db.models.fields.DateField', [], {}),
            'system': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['allocation.System']"})
        },
        'allocation.application': {
            'Meta': {'object_name': 'Application'},
            'allocation_round': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['allocation.AllocationRound']", 'null': 'True'}),
            ...
            'priority_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['allocation.PriorityArea']", 'null': 'True'}),
