...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ParticipantAccount.participant'
        db.delete_column('allocation_participantaccount', 'participant_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ParticipantAccount.participant'
        raise RuntimeError("Cannot reverse this migration. 'ParticipantAccount.participant' and its values cannot be restored.")
    ...
    models = {
        ...
        'allocation.participant': {
            ...
            'participantaccount': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['allocation.ParticipantAccount']", 'null': 'True'}),
