...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Convert fk on participant to a m2m on application
        for application in orm.Application.objects.all():
            participants = []
            for participant in orm.Participant.objects.filter(application=application):
                participants.append(participant)
            application.participant = participants
            application.save()
