...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Application.priority_area_radio_astronomy'
        db.delete_column('allocation_application', 'priority_area_radio_astronomy')

        # Deleting field 'Application.priority_area_national'
        db.delete_column('allocation_application', 'priority_area_national')

        # Deleting field 'Application.priority_area_directors'
        db.delete_column('allocation_application', 'priority_area_directors')

        # Deleting field 'Application.priority_area_geosciences'
        db.delete_column('allocation_application', 'priority_area_geosciences')

        # Deleting field 'Application.priority_area_partner'
        db.delete_column('allocation_application', 'priority_area_partner')


    def backwards(self, orm):
 
        # Adding field 'Application.priority_area_radio_astronomy'
        db.add_column('allocation_application', 'priority_area_radio_astronomy', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Application.priority_area_national'
        db.add_column('allocation_application', 'priority_area_national', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Application.priority_area_directors'
        db.add_column('allocation_application', 'priority_area_directors', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Application.priority_area_geosciences'
        db.add_column('allocation_application', 'priority_area_geosciences', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Application.priority_area_partner'
        db.add_column('allocation_application', 'priority_area_partner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
