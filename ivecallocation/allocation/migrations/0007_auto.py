...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field participant on 'Application'
        db.create_table('allocation_application_participant', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('application', models.ForeignKey(orm['allocation.application'], null=False)),
            ('participant', models.ForeignKey(orm['allocation.participant'], null=False))
        ))
        db.create_unique('allocation_application_participant', ['application_id', 'participant_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field participant on 'Application'
        db.delete_table('allocation_application_participant')
    ...
    models = {
        ...
        'allocation.application': {
            ...
            'participant': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['allocation.Participant']"}),
        ...
        'allocation.participant': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['allocation.Application']"}),
